...
function initialize() {
var center = new google.maps.LatLng(6.760825009855806, -66.84538344062503);
...
var request = { 
origin: "Lidice, la pastora caracas", 
destination: "San bernardino, caracas", 
...
var icons = new Array();
icons["red"] = new google.maps.MarkerImage('../../web/img_admin/Icons/Destino.png',
...
function getMarkerImage(iconColor) {
   ...
   if (!icons[iconColor]) {
      icons[iconColor] = new google.maps.MarkerImage('../../web/img_admin/Icons/Carro.png',
      // This marker is 20 pixels wide by 34 pixels tall.
      new google.maps.Size(20, 34),
      // The origin for this image is 0,0.
      new google.maps.Point(0,0),
  ...
  var iconImage = new google.maps.MarkerImage('../../web/img_admin/SVGs/Carro.svg',
      // This marker is 20 pixels wide by 34 pixels tall.
      new google.maps.Size(20, 34),
      // The origin for this image is 0,0.
      new google.maps.Point(0,0),
