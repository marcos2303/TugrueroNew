...
<div class="container">
	...
	<table id="example" class="table table-striped table-bordered table-responsive" width="100%" cellspacing="0">
			...
			<tfoot>
				<tr>
					<th><input id="id_seguro" name="id_seguro" type="text"></th>
	...
	<a class="btn btn-default"  href="<?php echo full_url."/adm/seguros/index.php?action=new"?>"><i class="fa fa-file-o fa-pull-left fa-border"></i>Agregar</a>
</div>
...
$(document).ready(function() {
    ...
    var table = $('#example').DataTable({
        ...
        "serverSide": true,
		 "sDom": 'ltrip',
        "ajax": "<?php echo full_url."/adm/seguros/index.php?action=list_json"?>",
		"language": {
